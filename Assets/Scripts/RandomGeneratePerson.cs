...
static public class RandomGeneratePerson
{
    ...
    private static readonly string[] race = new string[] { "Ork", "Krasnolud", "Goblin", "Elf", "Cz³owiek", "Gnom", "Pol-elf", "Pol-ork", "Hobbit" };
    private static readonly string[] lastName = new string[] { "Praudmoore", "von everec", "van Cleef", "Stormrage", "Kaji", "Majah", "Bloodchin", "Doomtrust", "Baggins", "Arevd", "Akkon", "Amit", "Mahale", "Hama", "Kernel", "Maraara", "Wedrowycz", "Pomidor", "Prostak", "Wiesniak", "Swiniopas", "Bardak" };
    private static readonly string[] fraction = new string[] { "Bandyta", "Najemnik", "Kaplan", "Nikt", "Paladyn", "Straznik", "Chlop", "Wampir", "Lowca Smokow", "Kupiec" };
    private static readonly string[] faith = new string[] { "Kult Slonca", "Kult Ognia", "Kult Smierci", "Kult Powietrza", "Kult Wody", "Kult Ziemii" };
